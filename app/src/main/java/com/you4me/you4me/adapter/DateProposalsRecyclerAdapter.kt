...
class DateProposalsRecyclerAdapter(
    private val dates: InviteeDatesRequiringApproval,
    private val viewModel: MainViewModel,
    private val context: Context,
    private val mixpanelAPI: MixpanelAPI,
) : RecyclerView.Adapter<DateProposalsRecyclerAdapter.MyViewHolder>() {
...
//             userName.text = "${date.name} invited you"
//            location.text = "${date.place}"
//            time.text = "${date.time}"
//            userDate.text = "${date.date}"
