...
class UpcomingDatesFragment :
        BaseFragment<MainViewModel, FragmentUpcomingDatesBinding, MainRepository>("UPCOMING_DATES"), UpcomingDatesRecyclerAdapter.CalendarResultListener{
    ...
    override fun getFragmentBinding(
        ...
        container: ViewGroup?
    ): FragmentUpcomingDatesBinding {
        return FragmentUpcomingDatesBinding.inflate(layoutInflater)
    }
