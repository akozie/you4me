...
class ReligionBottomSheetFragment : BottomSheetDialogFragment() {


    private lateinit var binding: FragmentReligionBottomSheetBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentReligionBottomSheetBinding.inflate(layoutInflater)
        return binding.root
    }
