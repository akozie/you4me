...
import com.you4me.you4me.databinding.FragmentUpcomingMyDatesBinding
...
class UpcomingMyDatesFragment :
    BaseFragment<MainViewModel, FragmentUpcomingMyDatesBinding, MainRepository>("UPCOMING_MY_DATE_SCREEN") {
    ...
    override fun getFragmentBinding(
        ...
        container: ViewGroup?,
    ) = FragmentUpcomingMyDatesBinding.inflate(layoutInflater)
