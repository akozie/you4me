...
import com.you4me.you4me.databinding.FragmentCompletedMyDatesBinding
...
class CompletedMyDatesFragment :
    BaseFragment<MainViewModel, FragmentCompletedMyDatesBinding, MainRepository>("COMPLETED_MY_DATE_SCREEN") {
    ...
    override fun getFragmentBinding(
        ...
        container: ViewGroup?,
    ) = FragmentCompletedMyDatesBinding.inflate(layoutInflater)
