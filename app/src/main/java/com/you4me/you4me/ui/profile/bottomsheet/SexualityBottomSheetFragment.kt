...
class SexualityBottomSheetFragment : BottomSheetDialogFragment() {

    private lateinit var binding: FragmentSexualityBottomSheetBinding
    private lateinit var radioGroupCustom: LinearLayout
    private var receivedList: List<SexualOrientation>? = null
    ...
    override fun onCreateView(
        ...
        binding = FragmentSexualityBottomSheetBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.saveBtn.setOnClickListener {
            val result = Bundle().apply {
                ...
                putString("sheet_id", "SEXUALITY")  // Unique tag for the sheet
            }
        ...
        binding.cancelIcon.setOnClickListener {
         ...
         receivedList = arguments?.let {
            SexualityBottomSheetFragmentArgs.fromBundle(it).SEXUAL.toList()
        }
    ...
    private fun setupCustomRadioGroup(container: LinearLayout, options: List<SexualOrientation>?) {
        ...
        if (options != null) {
            for ((index, item) in options.withIndex()) {
                ...
                view.setOnClickListener {
                    ...
                    sharedPrefHelper.saveString(SEXUALITY_ID, selectedValue.toString())
