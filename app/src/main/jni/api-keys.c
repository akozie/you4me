...
Java_com_you4me_you4me_utils_UtilityParam_getApiKey(JNIEnv *env, jobject thiz) {
    return (*env) ->NewStringUTF(env, "12b3-18f6"); //    12b30ff3-dc7d-4c0e-ae3f-2b0ce77818f6  12b3-18f6
}

JNIEXPORT jstring JNICALL
Java_com_you4me_you4me_utils_UtilityParam_getBaseUrl(JNIEnv *env, jobject thiz) {
    return (*env) ->NewStringUTF(env, "https://41zpx0c6ad.execute-api.us-east-1.amazonaws.com/dev/"); //       https://j3rmo1mo2a.execute-api.us-east-1.amazonaws.com/prod/     https://41zpx0c6ad.execute-api.us-east-1.amazonaws.com/dev/
}